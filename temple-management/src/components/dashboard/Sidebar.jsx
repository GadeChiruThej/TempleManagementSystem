...
// The Map icon has been added to the import list
import { X, LayoutDashboard, Users2, ShieldCheck, Search, Box, BarChart2, BrainCircuit, SearchX, PackageSearch, MessageSquare, Video, Map } from 'lucide-react';
...
const Sidebar = ({ userRole, isOpen, onClose }) => {
    ...
    const adminLinks = [
        ...
        { name: 'Temple Overview', path: `${basePath}/overview`, icon: <Map size={20} /> }, // <-- ADDED
        ...
        { name: 'CCTV Surveillance', path: `${basePath}/cctv`, icon: <Video size={20} /> },
